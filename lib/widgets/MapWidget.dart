...
class _MapboxWidgetState extends ConsumerState<MapboxWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return  MapWidget(
        ...
        cameraOptions: CameraOptions(
          zoom: 17,
          center: Point(
            coordinates: Position( 73.80739479158387, 18.46053379487418,),
          ),
        ),
  ...
  Future<void> _onMapCreated(MapboxMap mapboxMap) async {
    ...
    final ByteData bytes = await rootBundle.load("assets/images/pin.png"); // <- add your pin icon in assets
    final Uint8List markerImage = bytes.buffer.asUint8List();

    // Create annotation options
    var options = PointAnnotationOptions(
      geometry: Point(coordinates: Position( 73.80739479158387, 18.46053379487418,),),
      image: markerImage,
